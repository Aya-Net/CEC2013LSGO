...
public:
  ...
  void setMinRegion(variable min_reg) { min_region = min_reg; }
  void setMaxRegion(variable max_reg) { max_region = max_reg; }
protected:
  void evaluatePopulation(const vector<Individual> &pop, vector<Fitness> &fitness) const;
